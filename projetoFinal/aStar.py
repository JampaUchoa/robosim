...
def aStar(start):
    ...
    cameFrom = {}
    gScore = {start: 0}
    fScore = {start: calcDistance(start, goal)}
    ...
    while openSet:
        ...
        for i, j in nearby:
            ...
            tentativeGScore = gScore[current] + calcDistance(current, neighbor)
            ...
            if  tentativeGScore < gScore.get(neighbor, 0) or neighbor not in [i[1]for i in openSet]:
                ...
                fScore[neighbor] = tentativeGScore + calcDistance(neighbor, goal)
